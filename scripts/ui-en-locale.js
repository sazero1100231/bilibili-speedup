...
// catalogue through the map below so the `release-en/` bundle ships an
...
export const TRANSLATIONS = Object.freeze({
  ...
  "擴充功能目前已停用，請先在設定中啟用。":
    "The extension is disabled. Enable it in Settings first.",
  ...
  "已清除先前的本地量測；若診斷仍啟用且播放頁仍開啟，新的作用中場次會立即重新記錄。":
    "Cleared earlier local measurements. If diagnostics remain enabled and a playback page is still open, a new active session is recorded immediately.",
  "已產生包含最新作用中場次的本地 JSON 匯出檔。":
    "Generated a local JSON export containing the latest active sessions.",
  ...
  "診斷目前關閉；可匯出既有 ": "Diagnostics are off; you may export the existing ",
  " 場，但不會記錄新的播放問題。": " sessions, but new playback issues will not be recorded.",
  "已保存 ": "Saved ",
  " 場；匯出前有 ": " sessions; before export, ",
  " 個作用中播放頁無法即時擷取，既有資料仍會保留。":
    " active playback pages could not be captured live; existing data is retained.",
  "診斷正在收集；目前已保存 ": "Diagnostics are collecting; currently saved ",
  " 場播放，匯出前已同步最新作用中場次。":
    " playback sessions, with the latest active sessions synchronized before export.",
  ...
  "診斷狀態": "Diagnostics status",
  "正在讀取診斷狀態": "Loading diagnostics status",
  "啟用診斷並開始記錄": "Enable diagnostics and start recording",
  "正在啟用診斷": "Enabling diagnostics",
  "正在同步最新診斷": "Synchronizing latest diagnostics",
  "啟用失敗：": "Enable failed: ",
  "匯出失敗：": "Export failed: ",
  "總耗時": "Total time",
  "整體吞吐": "End-to-end throughput",
  "（保守計時）": " (conservative timing)",
  "保守計時": "conservative timing",
  "最近一場": "Latest session",
  "播放秒數": "Play seconds",
  "測速結果": "probe results",
